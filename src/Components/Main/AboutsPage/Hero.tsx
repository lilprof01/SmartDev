    ...
    <section className="h-[120vh] relative">
      ...
      >
        <motion.div
          ...
          className="w-full h-full bg-[url(/Hero/light1.jpg)] dark:bg-[url(/Hero/heromd.jpg)] lg:dark:bg-[url(/Hero/hero3.jpg)] bg-cover bg-center z-10 text-center flex flex-col justify-center items-center gap-3"
        >
